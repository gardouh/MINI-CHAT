package com.github.jmsoft.socketclient.Const;
...
public class ChatCst extends RecyclerView.Adapter<ChatCst.HistoryViewHolder> {

    private List<String> chatMessagesList;

    public ChatCst(List<String> historyList) {
